      ...
      <div>
        ...
        <div className="regcards">
          <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 w-80 singlelogin">
            ...
            <div className="p-5">
              <Link to="/register/cusregister">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Register as a Learner</h5>
              </Link>
          ...
          <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 w-80 singlelogin">
            ...
            <div className="p-5">
              <Link to="/register/empregister">
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Register as an Instructor</h5>
              </Link>
