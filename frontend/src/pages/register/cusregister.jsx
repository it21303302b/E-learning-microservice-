  ...
  return (
    <div className="form-bg-img">
      <div className="p-24">
        ...
        <div className="w-auto bg-white rounded-lg shadow dark:border md:mt-5 sm:max-w-l xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            ...
            <form className="space-y-4 md:space-y-6" autoComplete="off" onSubmit={handleSubmit}>
              ...
              <div className="w-full flex justify-center">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300 align-middle">
                    I accept the{' '}
