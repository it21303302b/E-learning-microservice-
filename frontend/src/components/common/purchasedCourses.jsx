              ...
              {courses.map((course) => (
                <div key={course?._id} className="mb-3 flex md:w-full md:h-52 rounded-2xl shadow-lg border overflow-hidden">
                  <img
                    ...
                    className="md:w-1/5 object-cover rounded-l-2xl border-r shadow-lg shadow-blue-400"
                  />
                  ...
                  <div className="md:w-1/5 content-evenly flex items-center justify-center">
                    ...
                    {course?.course_content && (
                      <button
                        onClick={() => handleDownload(course?.course_content?.zip_url)}
                        className="p-3 rounded-full bg-green-500 hover:bg-blue-400 hover:shadow hover:shadow-blue-600 relative group"
                      >
                        <svg
                        ...
                        <span className="absolute left-1/2 transform -translate-x-1/2 bottom-14 bg-gray-700 text-white text-xs rounded-md py-1 px-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
