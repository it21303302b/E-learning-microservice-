  ...
  useEffect(() => {
    function getCourses() {
      axios
        ...
        .then((res) => {
          const latestCourses = res.data.slice(0, 4)
    ...
    <div className="grid md:grid-cols-4 items-center">
      {courses.map((course, index) => (
        <div key={index} className="m-3">
          <div className="w-72 flex flex-col overflow-hidden rounded-lg border bg-white shadow-md hover:bg-gray-50 hover:shadow-blue-500">
